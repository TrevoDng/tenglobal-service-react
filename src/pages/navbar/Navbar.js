...
renderSwitch(holder) {
  ...
  return(
    ...
    <Link to="/"> 
    <svg id="logo-15" width="36" height="35" viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg"> 
    ...
    <span>TEN<span style={{ color: '#17cf97' }}> GLOBAL</span></span>
  ...
  <div className='nav-list'>
    ...
    className={this.state.clicked ? 
      ...
      <Link to="/contactus">Contact</Link></li>
        ...
        <li>
        <Link to="/homecontent"><Logout /></Link>
        </li>
    </ul>
